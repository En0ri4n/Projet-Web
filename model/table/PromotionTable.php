...
class PromotionTable extends AbstractTable
{
    ...
    public static string $TYPE_COLUMN = "Promotion.TypePromotion";
    ...
    public static string $PILOT_COLUMN = "Promotion.PilotePromotion";
    ...
    {
        return $this->defaultSelect(self::no_join(), $conditions, fn($a) => Promotion::fromArray($a));
    }

    public function selectLike(array $conditions, callable $fromArray): array|Promotion|null
    {
