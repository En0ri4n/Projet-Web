...
<div class="entreprise">
    <div class="description_entreprise">
        ...
        <div>
            <button class="boutons" id="postuler">Postuler</button>
            <button class="boutons" id="wishlist">Wishlist</button>
        </div>
    </div>
    <img id="image_entreprise_offre" src="/assets/logo1.png" alt="entreprise-logo">
</div>

<div class="titres">
    <span id="Nom">NomPoste</span>
    <span id="NivEtds">NivEtds</span>
...
<div class="box_competences">
    ...
    <div class="div_competences">
        <div class="competence">
            <img src="/assets/logo1.png" alt="Nom compétence">
            <span>NomCompetence</span>
        </div>
        <div class="competence">
            <img src="/assets/logo1.png" alt="Nom compétence">
            <span>NomCompetence</span>
...
<footer>
    <div class="div"></div>
    <div id="evaluation">
        Laisser une évaluation à l'entreprise
        <img class="etoile" src="/assets/logo1.png" alt="Etoile">
        <img class="etoile" src="/assets/logo1.png" alt="Etoile">
        <img class="etoile" src="/assets/logo1.png" alt="Etoile">
        <img class="etoile" src="/assets/logo1.png" alt="Etoile">
        <img class="etoile" src="/assets/logo1.png" alt="Etoile">
    ...
    <div class="contact">
        <div class="contacts">
            <span>Contacts</span>
            <div class="titres">
                <img src="/assets/logo1.png" alt="Contact">
                <span>Adresse</span>
            </div>
            <div class="titres">
                <img src="/assets/logo1.png" alt="Contact">
